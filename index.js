...
import mealCleanoxRoutes from "./routes/Cleanox/mealCleanoxRoutes.js";
...
app.use("/cleanox/off-days", workerOffDaysCleanoxRoutes);
app.use("/cleanox/kasbon", kasbonCleanoxRoutes);
app.use("/cleanox/overtime", overtimeCleanoxRoutes);
app.use("/cleanox/meal", mealCleanoxRoutes);
