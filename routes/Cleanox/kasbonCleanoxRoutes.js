...
import {
	...
	deletePayment,
	serveProof,
} from "../../controllers/Cleanox/kasbonCleanoxController.js";
import { uploadCleanoxKasbon } from "../../middleware/upload.js";
...
router.get("/proofs/:filename", requireAuth, serveProof);
router.get("/:id", requireAuth, getKasbonDetail);
router.post("/", requireAuth, uploadCleanoxKasbon.single("proof_file"), createKasbon);
router.put("/:id", requireAuth, uploadCleanoxKasbon.single("proof_file"), updateKasbon);
